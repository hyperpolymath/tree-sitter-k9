...
= Contributing — tree-sitter-k9
:revdate: 2026-MM-DD

== Audience

Developers working *on* `tree-sitter-k9`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/tree-sitter-k9.git
cd tree-sitter-k9
...
* Bugs in `tree-sitter-k9`: file at `hyperpolymath/tree-sitter-k9/issues`.
