...
// Replace tree-sitter-k9, Tree Sitter K9 — See README.adoc for details., just run, Tree Sitter K9 started successfully. with actuals
= tree-sitter-k9 — Quick Start for Users
:toc:
:toclevels: 2

== What is tree-sitter-k9?

Tree Sitter K9 — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./tree-sitter-k9-portable
----
...
[source]
----
Tree Sitter K9 started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/tree-sitter-k9/wiki
