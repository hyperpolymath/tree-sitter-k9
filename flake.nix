{
  description = "tree-sitter-k9 - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 tree-sitter-k9 development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P tree-sitter-k9.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/tree-sitter-k9 $out/bin/  # Rust
            # cp bin/tree-sitter-k9 $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/tree-sitter-k9";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-tree-sitter-k9" {
