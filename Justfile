...
doctor:
    @echo "Running diagnostics for tree-sitter-k9..."
...
help-me:
    @echo "=== tree-sitter-k9 Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/tree-sitter-k9/issues/new"
    @echo ""
